 ...
 */
final class Version20200723104949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INT NOT NULL, address VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, membership_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journal (id INT NOT NULL, periodicity VARCHAR(255) NOT NULL, subscription_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, organizes_id INT DEFAULT NULL, INDEX IDX_5D9F75A13FD02ABF (organizes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE borrowing (id INT AUTO_INCREMENT NOT NULL, borrower_id INT NOT NULL, document_id INT NOT NULL, start_date DATE NOT NULL, expected_return_date DATE NOT NULL, effective_return_date DATE NOT NULL, INDEX IDX_226E589711CE312B (borrower_id), INDEX IDX_226E5897C33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE audio_book (id INT NOT NULL, duration TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE audio_book ADD CONSTRAINT FK_8454BF6DBF396750 FOREIGN KEY (id) REFERENCES product (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE is_involved_in DROP FOREIGN KEY FK_D90AEDB761220EA6');
        ...
        $this->addSql('ALTER TABLE audio_book DROP FOREIGN KEY FK_8454BF6DBF396750');
        ...
        $this->addSql('ALTER TABLE is_involved_in DROP FOREIGN KEY FK_D90AEDB74584665A');
